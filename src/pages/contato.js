...
export default function Contato() {
  return (<main className='bg-primary pt-20'>
    ...
    <div className='container mx-auto mb-6 p-8 bg-white color-black shadow-md'>
      ...
      <p className='text-base md:text-lg lg:text-xl'>Bloco 3</p>
      <p className='text-base md:text-lg lg:text-xl'>(16) 3373-9639</p>
      <p className='text-base md:text-lg lg:text-xl pb-8'>grad@icmc.usp.br</p>
      <iframe
