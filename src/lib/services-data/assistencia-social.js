...
export default {
  ...
  text: <p>
    Leia atentamente o EDITAL PAPFE 2023 abaixo que dispõe sobre as normas do Programa de Apoio à Permanência e
    Formação Estudantil, destinado aos ingressantes na Universidade de São Paulo no ano de 2023:
    (<a
      rel='noreferrer noopener'
      className='hover:underline break-all'
      href='https://prip.usp.br/wp-content/uploads/sites/1128/dlm_uploads/2023/01/PRIP-PAPFE-EDITAL-2023.pdf'
      target="_blank"
    >https://prip.usp.br/wp-content/uploads/sites/1128/dlm_uploads/2023/01/PRIP-PAPFE-EDITAL-2023.pdf</a>)
    <br />
    Em caso de dúvidas entre em contato com o Serviço Social:
    social.prefeitura@sc.usp.br
  </p>,
  faq: [
    {
